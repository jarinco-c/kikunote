...
- 「えっと」「あの」などのフィラーや、挨拶・雑談は省略してください。
- 同じ話題について複数人が話した場合は、結論や合意内容を中心にまとめてください。
- テキストに時間帯の区切り（[0分〜3分頃]等）がある場合、これは録音を分割処理した目安です。区切りを無視して、会議全体を通して1つの議事録にまとめてください。
...
テキストに時間帯の区切り（[0分〜3分頃]等）がある場合、これは録音を分割処理した目安です。区切りを無視して、全体を通して1つの仕様書にまとめてください。
